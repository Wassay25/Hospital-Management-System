...
//
//// ---- Color palette ----
//// Simple flat colors -- easy to read and change
//namespace C {
//    const sf::Color BG = sf::Color(245, 247, 250);
//    const sf::Color SIDEBAR = sf::Color(41, 55, 74);
//    const sf::Color SIDEBAR_H = sf::Color(58, 78, 102);
//    const sf::Color SIDEBAR_A = sf::Color(52, 152, 219);
//    const sf::Color TOPBAR = sf::Color(41, 55, 74);
//    const sf::Color PANEL = sf::Color(255, 255, 255);
//    const sf::Color BORDER = sf::Color(218, 224, 232);
//    const sf::Color TEXT = sf::Color(30, 40, 55);
//    const sf::Color TEXT_L = sf::Color(120, 135, 150);
//    const sf::Color TEXT_W = sf::Color(240, 244, 248);
//    const sf::Color ACCENT = sf::Color(52, 152, 219);
//    const sf::Color ACCENT_H = sf::Color(41, 128, 185);
//    const sf::Color DANGER = sf::Color(231, 76, 60);
//    const sf::Color DANGER_H = sf::Color(192, 57, 43);
//    const sf::Color SUCCESS = sf::Color(39, 174, 96);
//    const sf::Color WARNING = sf::Color(230, 126, 34);
//    const sf::Color ROW_ALT = sf::Color(248, 250, 252);
//    const sf::Color ROW_SEL = sf::Color(214, 234, 248);
//    const sf::Color ROW_HOV = sf::Color(232, 242, 252);
//    const sf::Color INPUT_BG = sf::Color(255, 255, 255);
//    const sf::Color HDR_BG = sf::Color(52, 73, 94);
//    const sf::Color STAT_BG = sf::Color(255, 255, 255);
//}
//
...
//    int    maxLength = 511;   // per-field character limit (≤ 511)
//
...
//        placeholder[127] = '\0';
//        maxLength = (maxLen > 511) ? 511 : (maxLen < 1 ? 1 : maxLen);
//    }
//
...
//            if (ch == 8) {  // Backspace
//                if (cursorPos > 0) {
//                    // Shift characters left from cursorPos-1
...
//                }
//            }
//            else if (ch == 127) {  // Ctrl+Backspace / DEL via TextEntered (some platforms)
//                // handled by KeyPressed Delete below
//            }
//            else if (ch >= 32 && ch < 127 && len < maxLength) {
//                // Shift characters right to make room at cursorPos
...
//                    buffer[i] = buffer[i + 1];
//                buffer[len - 1] = '\0';
//                // cursorPos stays the same (now points at the char after deleted one)
//            }
//        }
//    }
//
...
//            ph.setCharacterSize(14); ph.setFillColor(C::TEXT_L);
...
//        else if (secondary) box.setFillColor(hovered ? sf::Color(80, 100, 120) : sf::Color(60, 80, 100));
...
//            bar.setFillColor(sf::Color(180, 195, 210));
//            win.draw(bar);
//        }
//    }
//
...
//
//        // App title with a simple cross/plus icon prefix
//        text(w, font, u8"\u271A  MediCore HMS", 16.f, 14.f, 18, C::TEXT_W);
//
//        // Show logged-in user info on the right side
//        if (gs.loggedInID >= 0) {
//            char info[300];
//            snprintf(info, sizeof(info), u8"\u25CF  %s  |  %s",
//                gs.loggedInRole, gs.loggedInName);
//            sf::Text t2;
//            t2.setFont(font);
//            t2.setString(info);
//            t2.setCharacterSize(13);
//            t2.setFillColor(sf::Color(170, 195, 220));
//            t2.setPosition(1270.f - t2.getLocalBounds().width, 17.f);
//            w.draw(t2);
//        }
//        // Thin bottom accent line
//        rect(w, 0.f, 52.f, 1280.f, 2.f, C::ACCENT);
//    }
//
//    // Left sidebar
//    struct SidebarItem {
...
//
//        // Sidebar background
//        rect(w, 0.f, 54.f, 200.f, 666.f, C::SIDEBAR);
//
//        int clicked = -1;
//        for (int i = 0; i < count; i++) {
//            float iy = 54.f + i * 48.f;
//            bool active = (gs.currentScreen == items[i].target);
//            bool hov = sf::FloatRect(0.f, iy, 200.f, 46.f).contains(mouse);
//
//            // Row background
//            sf::Color bg = C::SIDEBAR;
//            if (active) bg = C::SIDEBAR_A;
//            else if (hov)    bg = C::SIDEBAR_H;
//            rect(w, 0.f, iy, 200.f, 46.f, bg);
//
//            // Left accent bar for active item
//            if (active)
//                rect(w, 0.f, iy, 4.f, 46.f, sf::Color(255, 255, 255, 180));
//
//            // Label color
//            sf::Color tc = items[i].isDanger
//                ? sf::Color(255, 120, 100)
//                : active
//                ? sf::Color::White
//                : sf::Color(190, 205, 220);
//
//            text(w, font, items[i].label, 16.f, iy + 15.f, 13, tc);
//
...
//        // Light drop shadow
//        rect(w, x + 3.f, y + 3.f, pw, ph, sf::Color(0, 0, 0, 20));
//        // Panel body
//        rect(w, x, y, pw, ph, C::PANEL, C::BORDER, 1.f);
//        // Header
//        if (title && title[0]) {
//            rect(w, x, y, pw, 40.f, C::HDR_BG);
//            text(w, font, title, x + 14.f, y + 12.f, 14, C::TEXT_W);
//            rect(w, x, y + 40.f, pw, 1.f, C::BORDER);
//        }
//    }
//
//    // Table header
...
//
//        sf::Color bg = t.isError ? sf::Color(180, 40, 40, a8)
//            : sf::Color(30, 130, 60, a8);
...
//
//// ---- Sidebar item lists ----
//// Sidebar labels with simple Unicode icons (BMP range, works in C++ u8 strings)
//// Icons: house, calendar, list, credit-card, pill, magnifier, wallet, arrow
//static Draw::SidebarItem g_patientSidebar[] = {
//    { u8"\u2302  Overview",           Screen::PATIENT_DASHBOARD,      false },
//    { u8"\u25A6  Book Appointment",   Screen::PAT_BOOK_APPOINTMENT,   false },
//    { u8"\u2630  My Appointments",    Screen::PAT_VIEW_APPOINTMENTS,  false },
//    { u8"\u25A3  My Bills",           Screen::PAT_VIEW_BILLS,         false },
//    { u8"\u2764  My Prescriptions",   Screen::PAT_VIEW_PRESCRIPTIONS, false },
//    { u8"\u2315  Search Doctors",     Screen::PAT_SEARCH_DOCTOR,      false },
//    { u8"\u25CE  Top Up Balance",     Screen::PAT_TOP_UP,             false },
//    { u8"\u21B8  Logout",             Screen::MAIN_MENU,              true  },
//};
//
//static Draw::SidebarItem g_doctorSidebar[] = {
//    { u8"\u2302  Overview",             Screen::DOCTOR_DASHBOARD,       false },
//    { u8"\u2609  Today's Apts",         Screen::DOC_TODAY_APPOINTMENTS, false },
//    { u8"\u2714  Mark Complete",        Screen::DOC_MARK_COMPLETE,      false },
//    { u8"\u2715  Mark No-Show",         Screen::DOC_MARK_NOSHOW,        false },
//    { u8"\u270E  Write Prescription",   Screen::DOC_WRITE_PRESCRIPTION, false },
//    { u8"\u25A6  Patient History",      Screen::DOC_PATIENT_HISTORY,    false },
//    { u8"\u21B8  Logout",               Screen::MAIN_MENU,              true  },
//};
//
//static Draw::SidebarItem g_adminSidebar[] = {
//    { u8"\u2302  Dashboard",          Screen::ADMIN_DASHBOARD,        false },
//    { u8"\u271A  Add Doctor",         Screen::ADM_ADD_DOCTOR,         false },
//    { u8"\u2716  Remove Doctor",      Screen::ADM_REMOVE_DOCTOR,      false },
//    { u8"\u2630  All Patients",       Screen::ADM_VIEW_PATIENTS,      false },
//    { u8"\u2630  All Doctors",        Screen::ADM_VIEW_DOCTORS,       false },
//    { u8"\u25A6  Appointments",       Screen::ADM_VIEW_APPOINTMENTS,  false },
//    { u8"\u25A3  Unpaid Bills",       Screen::ADM_VIEW_UNPAID_BILLS,  false },
//    { u8"\u21E5  Discharge Patient",  Screen::ADM_DISCHARGE_PATIENT,  false },
//    { u8"\u26A0  Security Log",       Screen::ADM_SECURITY_LOG,       false },
//    { u8"\u25B6  Daily Report",       Screen::ADM_DAILY_REPORT,       false },
//    { u8"\u21B8  Logout",             Screen::MAIN_MENU,              true  },
//};
//
//// ---- Status message ----
...
//
//    // Center card
//    float pw = 360.f, ph = 400.f;
//    float px = (1280.f - pw) / 2.f, py = 140.f;
//
//    // Card shadow (simple dark rect slightly offset behind)
//    Draw::rect(w, px + 4.f, py + 4.f, pw, ph, sf::Color(0, 0, 0, 30));
//    // Card itself
//    Draw::rect(w, px, py, pw, ph, C::PANEL, C::BORDER, 1.f);
//
//    // Card header bar
//    Draw::rect(w, px, py, pw, 70.f, C::TOPBAR);
//
//    // Hospital cross icon + title
//    Draw::textCentered(w, a.font, u8"\u271A  MediCore HMS",
//        px + pw / 2.f, py + 20.f, 18, C::TEXT_W);
//    Draw::textCentered(w, a.font, "Hospital Management System",
//        px + pw / 2.f, py + 48.f, 11, sf::Color(160, 185, 210));
//
//    // Separator
//    Draw::rect(w, px + 16.f, py + 72.f, pw - 32.f, 1.f, C::BORDER);
//
//    // Buttons
...
//        Draw::text(w, a.font, attempts, px + 20.f, py + 196.f, 12, C::DANGER);
//    }
//
...
//    Draw::rect(w, ix, py + 52.f, pw / 2.f - 30.f, 180.f, sf::Color(245, 248, 252), C::BORDER, 1.f);
...
//        Draw::text(w, a.font, balLine, cx + 14.f, cy + 34.f, 12, sf::Color(140, 190, 230));
//    }
//
//    // Stat cards
...
//        Draw::text(w, a.font, sub, cx + 14.f, cy + 34.f, 12, sf::Color(140, 190, 230));
//    }
//
...
//        cx + 14.f, cy + 34.f, 12, sf::Color(140, 190, 230));
//
...
//        // Slot reference box
//        float sx = cx + 680.f;
//        Draw::rect(w, sx, cy + 66.f, 360.f, 200.f, sf::Color(245, 248, 252), C::BORDER, 1.f);
...
//        float px2 = (1280.f - pw2) / 2.f, py2 = 200.f;
...
//            sf::Color(245, 248, 252), C::BORDER, 1.f);
...
//            sf::Color(255, 245, 240), C::DANGER, 1.f);
...
//        Draw::text(w, a.font, rTitle, cx + 12.f, cy + 46.f, 13, C::TEXT_L);
//
...
//        Draw::text(w, a.font, revLine, cx + 12.f, cy + 148.f, 15, C::SUCCESS);
//
//        Draw::text(w, a.font, "Doctor Summary", cx + 12.f, cy + 178.f, 14, C::TEXT);
...
//        mkBtn(0, cx + 12.f, cy + 500.f, u8"\u2714  Book Appointment");
//        mkBtn(1, backX, cy + 500.f, u8"\u2190  Back", false, true);
//        break;
//    case Screen::PAT_VIEW_APPOINTMENTS:
//        mkBtn(0, cx + 12.f, cy + 620.f, u8"\u2716  Cancel Selected", true);
//        mkBtn(1, backX, cy + 620.f, u8"\u2190  Back", false, true);
//        break;
//    case Screen::PAT_VIEW_BILLS:
//        mkBtn(0, cx + 12.f, cy + 600.f, u8"\u25CE  Pay Selected Bill");
//        mkBtn(1, backX, cy + 600.f, u8"\u2190  Back", false, true);
//        break;
//    case Screen::PAT_TOP_UP: {
//        float px2 = (1280.f - 400.f) / 2.f;
//        mkField(0, px2 + 16.f, 310.f, "Amount in PKR");
//        mkBtn(0, px2 + 16.f, 362.f, u8"\u271A  Add Funds");
//        mkBtn(1, px2 + 16.f + 160.f, 362.f, u8"\u2190  Cancel", false, true);
//        break;
//    }
//    case Screen::PAT_VIEW_PRESCRIPTIONS:
//    case Screen::DOC_TODAY_APPOINTMENTS:
...
//    case Screen::ADM_SECURITY_LOG:
//    case Screen::ADM_DAILY_REPORT:
//        mkBtn(0, backX, cy + 624.f, u8"\u2190  Back", false, true);
//        break;
//    case Screen::PAT_SEARCH_DOCTOR:
...
//        mkBtn(0, cx + 12.f, cy + 432.f, u8"\u2714  Confirm");
//        mkBtn(1, backX, cy + 432.f, u8"\u2190  Back", false, true);
//        break;
//    case Screen::DOC_WRITE_PRESCRIPTION:
...
//        mkBtn(0, cx + 12.f, cy + 330.f, u8"\u2714  Save Prescription");
//        mkBtn(1, backX, cy + 330.f, u8"\u2190  Back", false, true);
//        break;
//    case Screen::DOC_PATIENT_HISTORY:
//        mkField(0, cx + 12.f, cy + 66.f, "Patient ID");
//        mkBtn(0, cx + 12.f, cy + 114.f, u8"\u25B6  View History");
//        mkBtn(1, backX, cy + 114.f, u8"\u2190  Back", false, true);
//        break;
//    case Screen::ADM_ADD_DOCTOR:
//        for (int i = 0; i < 5; i++) {
...
//                i == 4);
//        }
//        mkBtn(0, cx + 12.f, cy + 430.f, u8"\u271A  Add Doctor");
//        mkBtn(1, backX, cy + 430.f, u8"\u2190  Back", false, true);
//        break;
//    case Screen::ADM_REMOVE_DOCTOR:
//        mkField(0, cx + 12.f, cy + 484.f, "Doctor ID");
//        mkBtn(0, cx + 12.f, cy + 572.f, u8"\u2716  Remove Doctor", true);
//        mkBtn(1, backX, cy + 572.f, u8"\u2190  Back", false, true);
//        break;
//    case Screen::ADM_DISCHARGE_PATIENT:
//        mkField(0, cx + 12.f, cy + 66.f, "Patient ID");
//        mkBtn(0, cx + 12.f, cy + 230.f, u8"\u21E5  Discharge", true);
//        mkBtn(1, backX, cy + 230.f, u8"\u2190  Back", false, true);
//        break;
//    default: break;
//    }
//}
...
//    {
//        float cx2 = (1280.f - 300.f) / 2.f, startY = 230.f;
//        const char* labels[] = {
//            u8"\u25B6  Login as Patient",
//            u8"\u25B6  Login as Doctor",
//            u8"\u25B6  Login as Admin",
//            u8"\u271A  Register New Patient"
//        };
//        for (int i = 0; i < 4; i++)
//            mainMenuBtns[i].setup(cx2, startY + i * 58.f, 300.f, 42.f,
//                labels[i], false, i == 3);
//    }
//
//    // ---- Login buttons ----
//    loginBtns[0].setup(1280.f / 2.f - 170.f, 370.f, 130.f, 38.f, u8"\u2714  Login");
//    loginBtns[1].setup(1280.f / 2.f + 10.f, 370.f, 130.f, 38.f, u8"\u2190  Back", false, true);
//
//    // ---- Register buttons ----
//    registerBtns[0].setup(340.f, 496.f, 150.f, 38.f, u8"\u271A  Register");
//    registerBtns[1].setup(500.f, 496.f, 120.f, 38.f, u8"\u2190  Back", false, true);
//
//    sf::Clock    clock;
...
//                clickHappened = true;
//                // Always update mousePos from the release event so clicks
//                // work correctly even when the mouse has not moved since last
//                // MouseMoved event.
//                mousePos = { (float)event.mouseButton.x,
...
//
//            // ---- Focus assignment on press (not release) ----
//            // Using MouseButtonPressed prevents a race where clearAllFocus()
//            // inside the click handler would immediately strip the focus we
//            // just set.
...
//                }
//
//                // Count only fields that are actually visible (size > 0)
//                int activeCnt = 0;
//                for (int i = 0; i < cnt; i++)
//                    if (flds[i]->box.getSize().x > 1.f) activeCnt++;
//
//                bool advanced = false;
//                if (activeCnt > 0) {
//                    for (int i = 0; i < cnt; i++) {
...
//                            int next = (i + 1) % cnt;
//                            while (flds[next]->box.getSize().x <= 1.f)
//                                next = (next + 1) % cnt;
...
//                    loginFields[0].setup(1280.f / 2.f - 170.f, 280.f, 340.f, 38.f, "Enter Patient ID");
//                    loginFields[1].setup(1280.f / 2.f - 170.f, 346.f, 340.f, 38.f, "Enter Password");
...
//                    loginFields[0].setup(1280.f / 2.f - 170.f, 280.f, 340.f, 38.f, "Enter Doctor ID");
//                    loginFields[1].setup(1280.f / 2.f - 170.f, 346.f, 340.f, 38.f, "Enter Password");
//                    loginFields[0].clear(); loginFields[1].clear();
//                    loginFields[0].password = false; loginFields[1].password = true;
//                    clearAllFocus(); gs.loginAttempts = 0;
...
//                    loginFields[0].setup(1280.f / 2.f - 170.f, 280.f, 340.f, 38.f, "Enter Admin ID");
//                    loginFields[1].setup(1280.f / 2.f - 170.f, 346.f, 340.f, 38.f, "Enter Password");
//                    loginFields[0].clear(); loginFields[1].clear();
//                    loginFields[0].password = false; loginFields[1].password = true;
//                    clearAllFocus(); gs.loginAttempts = 0;
...
//                    sf::FloatRect itemRect(0.f, 54.f + si * 48.f, 200.f, 46.f);
